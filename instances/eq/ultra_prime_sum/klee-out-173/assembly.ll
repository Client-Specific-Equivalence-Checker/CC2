...
@.str.4 = private unnamed_addr constant [16 x i8] c"sum__CLEVER_EXT\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"i__CLEVER_EXT\00", align 1
@.str.6 = private unnamed_addr constant [14 x i8] c"n__CLEVER_EXT\00", align 1
...
define i32 @client() #0 {
  ...
  call void @klee_make_symbolic(i8* %19, i32 4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0))
