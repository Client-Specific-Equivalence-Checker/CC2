...
@.str.1 = private unnamed_addr constant [10 x i8] c"count_old\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"count_new\00", align 1
...
; <label>:44:                                     ; preds = %26
  ...
  %51 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %50)
  ret i32 0
}
