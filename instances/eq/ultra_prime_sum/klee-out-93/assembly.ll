...
define i32 @lib() #0 {
  ...
  call void @klee_make_symbolic(i8* %23, i32 4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %24 = bitcast i32* %7 to i8*
  call void @klee_make_symbolic(i8* %24, i32 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
