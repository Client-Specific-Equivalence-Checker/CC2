...
@.str = private unnamed_addr constant [14 x i8] c"i__CLEVER_EXT\00", align 1
...
define i32 @client() #0 {
  ...
  call void @klee_make_symbolic(i8* %16, i32 4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0))
  %17 = bitcast i32* %10 to i8*
  call void @klee_make_symbolic(i8* %17, i32 4, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0))
