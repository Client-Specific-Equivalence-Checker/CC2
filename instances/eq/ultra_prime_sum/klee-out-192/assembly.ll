...
@.str.4 = private unnamed_addr constant [14 x i8] c"i__CLEVER_EXT\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"n__CLEVER_EXT\00", align 1
@.str.6 = private unnamed_addr constant [16 x i8] c"sum__CLEVER_EXT\00", align 1
...
define i32 @client() #0 {
  ...
  call void @klee_make_symbolic(i8* %20, i32 4, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i32 0, i32 0))
  %21 = bitcast i32* %6 to i8*
  call void @klee_make_symbolic(i8* %21, i32 4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6, i32 0, i32 0))
