int lib(int sum, int i, int n, int CLEVER_ret_2_old, int CLEVER_ret_1_old, int CLEVER_ret_0_old, int CLEVER_ret_2_new, int CLEVER_ret_1_new, int CLEVER_ret_0_new)
{
  CLEVER_ret_0_new = 0;
  CLEVER_ret_1_new = 0;
  CLEVER_ret_2_new = 0;
