...
@.str = private unnamed_addr constant [16 x i8] c"sum__CLEVER_EXT\00", align 1
...
define i32 @client() #0 {
  ...
  call void @klee_make_symbolic(i8* %15, i32 4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0))
