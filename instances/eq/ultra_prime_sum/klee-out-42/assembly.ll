...
define i32 @client() #0 {
  ...
  call void @klee_make_symbolic(i8* %13, i32 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %14 = bitcast i32* %9 to i8*
  call void @klee_make_symbolic(i8* %14, i32 4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
...
; <label>:20:                                     ; preds = %0
  ...
  call void @klee_make_symbolic(i8* %23, i32 4, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0))
...
; <label>:30:                                     ; preds = %26, %20
  ...
  call void @klee_make_symbolic(i8* %33, i32 4, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.4, i32 0, i32 0))
